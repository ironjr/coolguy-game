...
public class DeathZone : MonoBehaviour
{
    ...
    {
        GameObject explosion = Instantiate(Explosions[Random.Range(0, Explosions.Length)]);
        explosion.transform.SetPositionAndRotation(GetRandomCoord(), GetRandomQuaternion());
    ...
    {
        GameObject explosion = Instantiate(Explosions[Random.Range(0, Explosions.Length)]);
        explosion.transform.SetPositionAndRotation(coord, GetRandomQuaternion());
        explosion.transform.localScale = scale;
    }
